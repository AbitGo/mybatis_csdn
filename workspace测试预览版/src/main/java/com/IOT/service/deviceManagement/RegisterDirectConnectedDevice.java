package com.IOT.service.deviceManagement;
...
public class RegisterDirectConnectedDevice {
	...
	public static void main(String args[]) throws Exception {
        ...
        String manufacturerId= "1223";
        String manufacturerName = "bjs";
        String deviceType = "ContactSensor";
        String model = "001";
