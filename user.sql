...
CREATE TABLE `sys_user` (
  ...
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1039 DEFAULT CHARSET=utf8 COMMENT='用户表';

-- ----------------------------
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', 'admin', '123456', 'test@mybatis.tk', '管理员用户', 0x1231231230, '2016-06-07 01:11:12');
INSERT INTO `sys_user` VALUES ('3', 'abc', 'abc', '15695203200@163.com', '测试用户', 0x1231231230, '2019-04-12 09:51:18');
INSERT INTO `sys_user` VALUES ('4', 'test', '123456', '1419561484@qq.com', '测试用户', 0x1231231230, '2016-06-07 00:00:00');
INSERT INTO `sys_user` VALUES ('1038', 'xxx', 'xaxa', '1419561484@qq.com', '测试用户', 0x1231231230, '2019-04-14 14:05:40');
